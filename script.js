...
const translations = {
  es: {
    ...
    'proj.p0b.title':    'Autodesk Cleaner Enterprise',
    'proj.p0b.desc':     'Script de PowerShell para limpieza profunda de archivos residuales de Autodesk, enfocado en entornos empresariales. Basado en Autodesk Nuke, adaptado para ser más intuitivo tanto para equipos técnicos como para usuarios finales.',
  ...
  en: {
    ...
    'proj.p0b.title':    'Autodesk Cleaner Enterprise',
    'proj.p0b.desc':     'PowerShell script for deep cleaning of residual Autodesk files, focused on enterprise environments. Based on Autodesk Nuke, adapted to be more intuitive for both technical teams and end users.',
